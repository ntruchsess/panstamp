 ...
 * Description:
 * 
 * SWAP mote definition class
 */
public class SwapMoteDef
{
  /**
   * True if the mote is a battery-operated sensor with low power capability
   */
  private boolean pwrDownMode = false;
   ...
   */
  public SwapMoteDef(String defFile) throws XmlException
  {
    Element elRoot, elem;
   ...
   * getPwrDownMode
   * 
   * Return the value of the power-down flag
   */
